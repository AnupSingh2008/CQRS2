...
namespace Shop.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<ShopException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<ShopException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (ShopException customException)
            {
                isFailure = true;
