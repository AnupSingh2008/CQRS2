...
namespace Shop.Services.Identity.Domain
{
    public class User : IIdentifiable
    {
        ...
        public User(Guid id, string email, string role)
        {
            ...
            {
                throw new ShopException(Codes.InvalidEmail, 
                    $"Invalid email: '{email}'.");
            }
            if (!Domain.Role.IsValid(role))
            {
                throw new ShopException(Codes.InvalidRole, 
                    $"Invalid role: '{role}'.");
            }        
            Id = id;
        ...
        public void SetPassword(string password, IPasswordHasher<User> passwordHasher)
        {
            ...
            {
                throw new ShopException(Codes.InvalidPassword, 
