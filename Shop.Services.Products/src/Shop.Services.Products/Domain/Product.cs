...
namespace Shop.Services.Products.Domain
{
    public class Product : BaseEntity
    {
        ...
        public void SetName(string name)
        {
            ...
            {
                throw new ShopException("empty_product_name", 
        ...
        public void SetVendor(string vendor)
        {
            ...
            {
                throw new ShopException("empty_product_vendor", 
        ...
        public void SetDescription(string description)
        {
            ...
            {
                throw new ShopException("empty_product_description",
        ...
        public void SetPrice(decimal price)
        {
            if (price <= 0)
            {
                throw new ShopException("invalid_product_price",
